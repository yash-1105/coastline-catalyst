import type { Belief } from '@/lib/site';
...
/** 26px thin-stroke navy icons for the "What we believe" columns. */
export function BeliefIcon({ name }: { name: Belief['icon'] }) {
  const common = { width: 26, height: 26, viewBox: '0 0 24 24', 'aria-hidden': true, ...stroke };
